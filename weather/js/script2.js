      ...
      function(data) {
        ...
        $.getJSON(weatherAPI,
          function(data) {
            ...
            var streetViewUrl = "https://maps.googleapis.com/maps/api/streetview?size=" + streetViewSize + "&location=" + streetViewLocation + "&key=" + streetViewKey + "&heading=" + getAngle() + "&pitch=-1.5";
